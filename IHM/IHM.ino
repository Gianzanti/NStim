...
#define PID_BR_CONFIG_PULSE_WIDTH 34
#define PID_EN_CONFIG_PULSE_WIDTH 64
#define PID_BR_CONFIG_CURRENT 35
#define PID_EN_CONFIG_CURRENT 65

// LIMITS
#define STIM_CURRENT_MIN 1
#define STIM_CURRENT_MAX 200
#define STIM_PULSE_WIDTH_MIN 1
#define STIM_PULSE_WIDTH_MAX 99
#define STIM_FREQUENCY_MIN 1
#define STIM_FREQUENCY_MAX 1000
...
#define STIM_PULSE_WIDTH_STEP 1
...
#define CONFIG_PULSE_WIDTH 0x08
...
unsigned int STIM_FREQUENCY = 500;   // 1 a 1000 - step 1
unsigned int STIM_PULSE_WIDTH = 50;  // 0.1 a 9.9 - step 0.1 - ponto fixo 1 casa
unsigned int STIM_TRAIN_INTERVAL = 50;
unsigned int STIM_CURRENT = 100;  // 0.1 a 20.0 - step 1 - ponto fixo 1 casa
